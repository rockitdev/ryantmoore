...
One caveat before the habits, because it trips people up. Organized notes do not become AI memory by magic. The assistant still needs a safe way to reach them, a reliable way to find the right one, and a way to tell the current version from an old one. Organization is what makes that connection useful once it exists. It is necessary, not sufficient.

## What good looks like

You do not need special software. You need your important information written down, current, and organized so the right answer is easy to find. A few habits do most of the work:
