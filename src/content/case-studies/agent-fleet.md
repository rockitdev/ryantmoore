...
metrics:
  - { value: '5 agents', label: 'one leads; others research, build, review, assist' }
  - { value: 'Daily', label: 'runs on its own, mostly unattended' }
  - { value: 'Right model', label: 'per job: judgment, speed, code, review' }
